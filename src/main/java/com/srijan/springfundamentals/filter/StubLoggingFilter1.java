...
@Slf4j
public class StubLoggingFilter1 extends OncePerRequestFilter {
    ...
    private static void logRequestHeader(ContentCachingRequestWrapper request, String prefix) {
        ...
        // headerName ->
        // Collections.list(request.getHeaders(headerName)).forEach(
        // headerValue -> log.info("{} {}: {}", prefix, headerName,
        // headerValue)));
        // log.debug("{}", prefix);
    }
    ...
    private static void logResponse(ContentCachingResponseWrapper response, String prefix) {
        ...
        // headerValue -> log.debug("{} {}: {}", prefix, headerName,
        // headerValue)));
        // log.debug("{}", prefix);
